<template>
	<div>
		<el-card class="category-container">
			...
			<el-table v-loading="loading" :data="catelist" style="width: 100%;margin-bottom: 20px;" row-key="categoryId" border height="280"
				:tree-props="{children: 'children'}">
				<el-table-column prop="categoryName" label="分类名称" >
				</el-table-column>
				<el-table-column label="是否有效" width="100">
					<template slot-scope="scope">
						<i class="el-icon-success" v-if="scope.row.isOk === true" style="color: lightgreen"></i>
				...
				<el-table-column prop="categoryRank" label="排序值" width="100">
				</el-table-column>
