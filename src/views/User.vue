    ...
    <el-card class="guest-container">
        ...
        <el-table v-loading="loading" border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" width="200">
                <template #default="scope">
                    <el-button type="text" @click="handleSolve(scope.row.userId)" v-if="scope.row.lockedFlag == 1">解除禁用
                    </el-button>
                    <el-popconfirm title="确定禁用吗？" @confirm="handleForbid(scope.row.userId)" v-else>
                        <template #reference>
