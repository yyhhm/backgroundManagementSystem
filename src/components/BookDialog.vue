<template>
	<el-dialog :title="type == 'add' ? '添加图书' : '修改图书'" :close-on-click-modal="false" :visible.sync="visible"
		...
		<el-form ref="refForm" :model="bookForm" :rules="rules" label-width="100px">
			<el-form-item label="图书分类" prop="selectedKeys">
				<el-cascader  v-model="bookForm.selectedKeys" style="width: 300px" :options="cateList" 
					:props="cascaderProps" @change="handleChangeCate" clearable placeholder="只能选择第三级">
				</el-cascader>
			</el-form-item>
			...
			<el-form-item label="图书主图" prop="file">
				<el-upload accept="jpg,jpeg,png" :class="{disUoloadSty:noneBtnImg}" :limit=this.limit
					action="/admin/upload" :on-success="handleUrlSuccess" :on-remove="handleRemove" ref="upload"
					list-type="picture-card" :file-list="bookForm.file" :on-change="handleChange" :auto-upload="false">
